...
public class AddSchduleActivity extends AppCompatActivity { //스케쥴 추가 액티비티
    ...
    @Override
    public boolean onPrepareOptionsMenu(Menu menu) { //스케줄 저장
        menu.clear();
    ...
    private void saveSchedule() { // 스케줄 저장
